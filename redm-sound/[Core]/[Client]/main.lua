...
------
RegisterNetEvent('RootLodge:RedMSound:PlayOnOne')
AddEventHandler('RootLodge:RedMSound:PlayOnOne', function(soundFile, soundVolume)
...
------
RegisterNetEvent('RootLodge:RedMSound:PlayOnAll')
AddEventHandler('RootLodge:RedMSound:PlayOnAll', function(soundFile, soundVolume)
    if hasPlayerLoaded then
        SendNUIMessage({
            transactionType = 'playSound',
            transactionFile = soundFile,
...
------
RegisterNetEvent('RootLodge:RedMSound:PlayWithinDistance')
AddEventHandler('RootLodge:RedMSound:PlayWithinDistance', function(otherPlayerCoords, maxDistance, soundFile, soundVolume)
	if hasPlayerLoaded then
